...
//     String a= licenseclassdata[dat]['className'];
//    int b= licenseclassdata[dat]['id'];
//     _insert(a ,b); 
//   }for(dat=0;dat<count;dat++){ 
//     String a= countriesdata[dat]['countryName'];
//     String b= countriesdata[dat]['countryCode'];
//    int c= countriesdata[dat]['id'];
//    _insertclassb(a ,b,c);
//   }}}
...
//   }
//    void _insertclassb(String name ,String code, int ids ) async {
